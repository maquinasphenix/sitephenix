...
3. Faz deploy das functions `google-reviews` e `contact-form`
...
As migrations de banco continuam podendo ser aplicadas manualmente com `supabase db push`.
Se depois quisermos automatizar isso tambem, basta adicionar a senha do banco remoto como secret do GitHub e recolocar essa etapa no workflow.
