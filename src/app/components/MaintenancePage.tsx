...
const productHighlights = [
  {
    ...
    description: "Impressora serigráfica semiautomática para empresas que precisam de precisão, repetibilidade e produtividade.",
    image: "https://i.postimg.cc/VLBGzkPS/phenixtron-levantamento-paralelo-png.jpg",
  },
  {
    title: "VULCAMPHENIX",
    category: "Secagem Industrial",
    description: "Túnel de secagem para produção contínua, estabilidade térmica e padronização no acabamento.",
    image: "https://i.postimg.cc/PfFZYGbL/vulcamphenix-png.jpg",
  },
  {
    title: "CURADORA UV",
    category: "Cura UV",
    description: "Cura instantânea para impressão técnica e industrial com mais velocidade e acabamento profissional.",
    image: "https://i.postimg.cc/cJg1pjtx/curadora-uv-phenix-png.jpg",
  },
  {
    title: "FLASH CURE",
    category: "Estamparia Têxtil",
    description: "Equipamento auxiliar para cura intermediária, ideal para produção têxtil com múltiplas cores.",
...
export function MaintenancePage() {
  return (
    <div className="min-h-screen bg-black text-white overflow-hidden">
      <header className="fixed top-0 left-0 right-0 z-50 bg-black/75 backdrop-blur-xl border-b border-[#FF5722]/20">
        <div className="container mx-auto px-4 h-20 flex items-center justify-between">
          <div>
            <div className="text-2xl md:text-3xl font-extrabold tracking-wider">
              PHENIX
            </div>
            <div className="text-[10px] md:text-xs text-[#FFB199] uppercase tracking-[0.25em]">
          ...
          <Button
            ...
            className="bg-[#FF5722] hover:bg-[#E64A19] text-white rounded px-5 md:px-7 py-5 font-bold shadow-[0_0_35px_rgba(255,87,34,.45)]"
          >
      ...
      <section className="relative min-h-screen pt-28 pb-16 flex items-center">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="inline-flex items-center gap-2 bg-[#FF5722]/15 border border-[#FF5722]/50 text-[#FFB199] rounded-full px-5 py-2 mb-5 shadow-[0_0_30px_rgba(255,87,34,.20)]">
                <Wrench size={18} />
                <span className="font-extrabold text-xs uppercase tracking-[0.22em]">
                  Site em manutenção
                </span>
              </div>

              <div className="relative overflow-hidden rounded-[2rem] border border-[#FF5722]/40 bg-gradient-to-br from-[#FF5722]/20 via-white/[0.06] to-black/20 p-6 md:p-8 mb-8 shadow-[0_0_55px_rgba(255,87,34,.22)]">
                <div className="absolute -right-16 -top-16 w-44 h-44 bg-[#FF5722]/30 blur-[60px] rounded-full" />
                <div className="relative z-10">
                  <p className="text-[#FFB199] uppercase tracking-[0.24em] text-xs font-black mb-3">
                    Aviso importante
                  </p>
              ...
              <div className="flex flex-wrap items-center gap-2 text-xs md:text-sm uppercase tracking-[0.20em] text-gray-300 mb-5">
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-8">
                <Button
                  onClick={() => window.open(whatsappUrl, "_blank")}
                  className="bg-green-500 hover:bg-green-600 text-white rounded px-9 py-7 text-base md:text-lg font-extrabold shadow-[0_0_35px_rgba(34,197,94,.35)]"
                >
                ...
                <Button
                  onClick={() => window.open(whatsappUrl, "_blank")}
                  variant="outline"
                  className="border-2 border-[#FF5722]/70 text-white bg-black/30 hover:bg-[#FF5722] hover:border-[#FF5722] rounded px-9 py-7 text-base md:text-lg font-extrabold"
                >
                  Conhecer soluções
            ...
            >
              ...
              <div className="relative rounded-[2.5rem] border border-[#FF5722]/25 bg-gradient-to-br from-white/10 to-white/[0.03] p-4 shadow-[0_0_70px_rgba(255,87,34,.22)]">
                ...
                <img
                  ...
                  alt="Máquina Phenix"
                  className="w-full h-[380px] md:h-[520px] object-contain"
                />
              </div>
            </motion.div>
          </div>
      ...
      <section className="py-16 md:py-24 bg-black relative">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center mb-14">
            <p className="text-[#FF5722] uppercase tracking-[0.28em] text-sm font-extrabold mb-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5 max-w-5xl mx-auto">
            {advantages.map((item, index) => (
              <motion.div
                ...
                className="group bg-[#101010] border border-white/10 hover:border-[#FF5722]/70 rounded-3xl p-8 min-h-[220px] shadow-[0_0_40px_rgba(0,0,0,.35)] transition-all"
              >
                <div className="w-14 h-14 rounded-2xl bg-[#FF5722]/15 border border-[#FF5722]/40 flex items-center justify-center mb-8 text-[#FF5722] group-hover:bg-[#FF5722] group-hover:text-white transition-all">
                  <item.icon size={28} />
                </div>
      ...
      <section className="py-16 md:py-24 bg-[#070707]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-7 max-w-6xl mx-auto">
            {productHighlights.map((product, index) => (
              <motion.div
                ...
                className="relative overflow-hidden rounded-[2rem] bg-gradient-to-br from-[#171717] to-[#090909] border border-white/10 hover:border-[#FF5722]/70 shadow-2xl"
              >
                <div className="absolute -right-20 -top-20 w-60 h-60 bg-[#FF5722]/20 blur-[70px] rounded-full" />
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 items-center p-6 md:p-8 relative z-10">
                  <div>
                    <span className="text-[#FF5722] text-xs font-extrabold uppercase tracking-[0.22em]">
                      {product.category}
                    </span>
                    <h3 className="text-3xl font-black mt-3 mb-4">
                      {product.title}
                    </h3>
                    ...
                    <Button
                      onClick={() => window.open(whatsappUrl, "_blank")}
                      className="bg-[#FF5722] hover:bg-[#E64A19] rounded px-6 py-5 font-extrabold"
                    >
                      Solicitar orçamento
                    </Button>
                  </div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.6 }}
              className="rounded-[2rem] bg-gradient-to-br from-[#151515] to-[#070707] border border-[#FF5722]/20 p-8 shadow-[0_0_60px_rgba(255,87,34,.12)]"
            >
              <div className="grid grid-cols-2 gap-4">
                {stats.map((stat) => (
                  ...
                  >
                    <div className="text-4xl font-black text-[#FF5722]">
                      {stat.number}
                    </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto">
            {reviews.map((review, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.45, delay: index * 0.08 }}
                className="rounded-3xl bg-gradient-to-b from-[#171717] to-[#090909] border border-white/10 p-7 shadow-xl"
              >
      ...
      <section className="relative py-20 md:py-28 overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          >
            ...
            <Button
              onClick={() => window.open(whatsappUrl, "_blank")}
              className="bg-green-500 hover:bg-green-600 text-white rounded px-10 py-8 text-lg md:text-xl font-black shadow-[0_0_45px_rgba(34,197,94,.45)]"
            >
      ...
      <footer className="bg-black border-t border-white/10 text-gray-500 py-9 text-center">
